    ...
    public static final RegistryObject<BlockEntityType<RegenOreEntity>> REGEN_ORE_ENTITY =
            BLOCK_ENTITIES.register("regen_ore_entity",
                    () -> BlockEntityType.Builder.of(RegenOreEntity::new,
                            ...
                            Re_Blocks.E_REGEN_PRESET01.get(),
                            Re_Blocks.E_REGEN_PRESET02.get(),
                            Re_Blocks.E_REGEN_PRESET03.get(),
                            Re_Blocks.E_REGEN_PRESET04.get(),
                            Re_Blocks.E_REGEN_PRESET05.get(),
                            Re_Blocks.E_REGEN_PRESET06.get(),
                            Re_Blocks.E_REGEN_PRESET07.get(),
                            Re_Blocks.E_REGEN_PRESET08.get(),
                            Re_Blocks.E_REGEN_PRESET09.get(),
                            Re_Blocks.E_REGEN_PRESET10.get(),
