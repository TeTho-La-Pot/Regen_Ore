package com.github.TeThoLaPot.re_ore.init.block;
...
public class Re_Blocks {
    ...
    //End Stone
    public static final RegistryObject<Block> E_REGEN_PRESET01 = registerBlock("e_regen_preset01",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET02 = registerBlock("e_regen_preset02",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET03 = registerBlock("e_regen_preset03",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET04 = registerBlock("e_regen_preset04",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET05 = registerBlock("e_regen_preset05",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET06 = registerBlock("e_regen_preset06",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET07 = registerBlock("e_regen_preset07",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET08 = registerBlock("e_regen_preset08",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET09 = registerBlock("e_regen_preset09",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));

    public static final RegistryObject<Block> E_REGEN_PRESET10 = registerBlock("e_regen_preset10",
            () -> new RegenOreBlocks(BlockBehaviour.Properties.copy(Blocks.END_STONE).noLootTable()));
